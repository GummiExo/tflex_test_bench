function [td1, ts1, tr1, tp_min, initial_value1, final_value1, td2, ts2, tr2, tp_max, initial_value2, final_value2, max_peak_value, min_peak_value] = step_parameters_flexion(input1,input2,output,plot_response)
clc;
...
%Start Time Posterior
t2_pos_input2 = find(input2.goal_angle(t1_pos_input2+data_factor:end) ~= 0,1) + t1_pos_input2 + data_factor - 2 ;
