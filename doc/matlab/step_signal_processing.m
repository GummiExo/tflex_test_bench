...
for i=1:length(files)
   ...
   for j=1:size(matrix_load.Data,1)
        ...
        elseif i == 9 && j == 1
            output.filtered(824:847) = (output.filtered(823) + output.filtered(848))/2;
        elseif i == 9 && j == 3
            output.filtered(684:769) = (output.filtered(683) + output.filtered(770))/2;
        elseif i == 9 && j == 4
            output.filtered(626:666) = (output.filtered(625) + output.filtered(667))/2;
            output.filtered(746:774) = (output.filtered(745) + output.filtered(775))/2;
        elseif i == 9 && j == 5
            output.filtered(628:670) = (output.filtered(627) + output.filtered(671))/2;
            output.filtered(744:768) = (output.filtered(743) + output.filtered(769))/2;
        elseif i == 9 && j == 6
            output.filtered(622:653) = (output.filtered(621) + output.filtered(654))/2;
            output.filtered(733:761) = (output.filtered(732) + output.filtered(762))/2;
            output.filtered(815:835) = (output.filtered(814) + output.filtered(836))/2;
        elseif i == 9 && j == 7
            output.filtered(634:689) = (output.filtered(633) + output.filtered(690))/2;
            output.filtered(839:894) = (output.filtered(838) + output.filtered(895))/2;
        elseif i == 9 && j == 8
            output.filtered(875:908) = (output.filtered(874) + output.filtered(909))/2;
        elseif i == 9 && j == 9
            output.filtered(9:19) = (output.filtered(8) + output.filtered(20))/2;
            output.filtered(660:691) = (output.filtered(659) + output.filtered(692))/2;
        elseif i == 9 && j == 10
            output.filtered(854:937) = (output.filtered(853) + output.filtered(938))/2;
        elseif i == 9 && j == 11
            output.filtered(863:911) = (output.filtered(862) + output.filtered(912))/2;
            output.filtered(926:940) = (output.filtered(925) + output.filtered(941))/2;
        elseif i == 9 && j == 12
            output.filtered(877:906) = (output.filtered(876) + output.filtered(907))/2;    
        elseif i == 9 && j == 13
            output.filtered(664:689) = (output.filtered(663) + output.filtered(690))/2;  
        elseif i == 9 && j == 16
            output.filtered(622:696) = (output.filtered(621) + output.filtered(697))/2;
            output.filtered(846:886) = (output.filtered(845) + output.filtered(887))/2;
        elseif i == 9 && j == 17
            output.filtered(773:863) = (output.filtered(772) + output.filtered(864))/2; 
        elseif i == 9 && j == 19
            output.filtered(777:808) = (output.filtered(776) + output.filtered(809))/2; 
...
step_info(1).ts2(8-2) = [];
step_info(1).ts2(9-3) = [];
step_info(1).ts2(10-4) = [];
step_info(1).ts2(11-5) = [];
step_info(1).ts2(12-6) = [];
step_info(1).ts2(13-7) = [];
step_info(1).ts2(14-8) = [];
...
step_info(3).ts1(5-2) = [];
step_info(3).ts1(8-3) = [];
step_info(3).ts1(10-4) = [];
step_info(3).ts1(11-5) = [];
step_info(3).ts1(12-6) = [];
step_info(3).ts1(13-7) = [];
step_info(3).ts1(14-8) = [];
step_info(3).ts1(15-9) = [];

step_info(4).td2(11) = [];
step_info(4).td2(12-1) = [];
